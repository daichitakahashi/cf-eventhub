/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f816d7d5f4179fbbe4d8ff62decf6c9a)
// Runtime types generated with workerd@1.20260910.1 2026-06-13 nodejs_compat
interface __BaseEnv_Env {
	SINK_BUCKET: R2Bucket;
	STABLE_QUEUE: Queue;
	FLAKY_QUEUE: Queue;
	EVENT_HUB: DurableObjectNamespace<import("./src/index").DevEventHub>;
	EVENT_HUB_REGISTRY: DurableObjectNamespace<import("./src/index").EventHubRegistry>;
	FLAKY_WORKFLOW: Workflow<Parameters<import("./src/index").FlakyWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DevEventHub" | "EventHubRegistry";
	}
