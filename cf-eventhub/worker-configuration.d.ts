/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1735c2d46c124af3f59972e47754a29a)
// Runtime types generated with workerd@1.20260616.1 2026-05-02 nodejs_compat
interface __BaseEnv_Env {
	EVICTION_ARCHIVE: R2Bucket;
	EVENT_HUB: DurableObjectNamespace<import("./src/test").TestEventHub>;
	EVENT_HUB_WITH_JOB_ID: DurableObjectNamespace<import("./src/test").TestEventHubWithJobId>;
	EVENT_HUB_WITH_DELETE_EVICTION: DurableObjectNamespace<import("./src/test").TestEventHubWithDeleteEviction>;
	EVENT_HUB_WITH_ARCHIVE_EVICTION: DurableObjectNamespace<import("./src/test").TestEventHubWithArchiveEviction>;
	EVENT_HUB_WITH_FAILING_ARCHIVE_EVICTION: DurableObjectNamespace<import("./src/test").TestEventHubWithFailingArchiveEviction>;
	REGISTERED_EVENT_HUB: DurableObjectNamespace<import("./src/test").TestRegisteredEventHub>;
	EVENT_HUB_REGISTRY: DurableObjectNamespace<import("./src/test").EventHubRegistry>;
	EVENT_HUB_WITH_FAILING_REGISTRY: DurableObjectNamespace<import("./src/test").TestEventHubWithFailingRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/test");
		durableNamespaces: "TestEventHub" | "TestEventHubWithJobId" | "TestEventHubWithDeleteEviction" | "TestEventHubWithArchiveEviction" | "TestEventHubWithFailingArchiveEviction" | "EventHubRegistry" | "TestRegisteredEventHub" | "TestEventHubWithFailingRegistry";
	}
