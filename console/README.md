...
EventHub Console is a web UI for inspecting EventHub payloads and delivery jobs.
It lets operators view recent events, inspect delivery status and errors, create
test events, and redrive failed delivery jobs.
...
```ts
import { createWebConsole } from "@cf-eventhub/console";
